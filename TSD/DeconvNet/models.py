...
def unet(input_shape):
    ...
    x = _inverted_residual_block(x2, 16, (3, 3), t=1, strides=1, n=1)
    x4 = _inverted_residual_block(x, 24, (3, 3), t=4, strides=2, n=2)
    x8 = _inverted_residual_block(x4, 32, (3, 3), t=4, strides=2, n=3)
    x = _inverted_residual_block(x8, 64, (3, 3), t=4, strides=1, n=1)

    x = Deconv2D(24, kernel_size=2, strides=2)(x)
    x = add([x4, x])
    x = Conv2D(24, 3, padding='same', kernel_initializer='he_normal')(x)
